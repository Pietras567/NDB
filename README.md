...
This project is a **Car Rental Application** that uses **MongoDB** as the primary database and **Redis** as a caching
mechanism. The application is built using **Java** and managed with **Gradle**.
...
3. **MongoDB** and **Redis** servers running locally or use docker-compose file.

---

## Cloning the Repository

To clone the project repository `Redis` branch:

```bash
git clone https://github.com/Pietras567/NDB.git --branch Redis
cd NDB
```
